...
int main() {
	...
	NSMutableArray *testArray2 = [NSMutableArray arrayWithObjects:@4, @3, @10, @44, @6, @4, @1, @7, nil];
	...
	for (int i = 0; i < testArray2.count; i++) {
		int tmp = [[testArray2 objectAtIndex:i] intValue];
		[testArray2 replaceObjectAtIndex:i withObject:@(++tmp)];
	}
